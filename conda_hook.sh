export CONDA_EXE="$(cygpath 'C:\Users\shash\anaconda3\New folder\New folder\Scripts\conda.exe')"
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE="$(cygpath 'C:\Users\shash\anaconda3\New folder\New folder\python.exe')"
